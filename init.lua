...
--  @license    MIT
--  https://github.com/NsLib/blog-code-snippet/tree/master/hammerspoon

--  @changer    qoiuy <iszhanggc@163.com>
--  @time       2018年09月07日15:56:09
--  @log        修改为自己常用的按键：iTrem              ->  alt + ;
--                                    Navicat PreMium    ->  alt + n 
--                                    weixin             ->  alt + w
--                                    IDEA               ->  alt + i
--                                    Eclipse            ->  alt + e
--                                    Google Chrome      ->  alt + g
